...
import { auth } from './data-test-attributes';

import countryDialCodes from '../../../node_modules/aws-amplify-react/src/Auth/common/country-dial-codes.js';
import defaultSignUpFields from '../../../node_modules/aws-amplify-react/src/Auth/common/default-sign-in-fields'
...
export default class SignUp extends AuthPiece {
    ...
    signUp() {
        ...
        if (this.inputs.password !== this.inputs.password1) {
        ...
        inputKeys.forEach((key, index) => {
            if (!['username', 'password', 'password1', 'checkedValue', 'dial_code'].includes(key)) {
